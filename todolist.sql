...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 15 Mar 2020, 22:26:08
...
-- Veritabanı: `laratest`
--
CREATE DATABASE IF NOT EXISTS `laratest` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `laratest`;
...
(4, '2020_03_01_190235_create_tasks_table', 1),
(5, '2020_03_01_192933_create_shows_table', 1);
...
--
-- Tablo için AUTO_INCREMENT değeri `shows`
--
ALTER TABLE `shows`
...
('root', '[{\"db\":\"todolist\",\"table\":\"todos\"},{\"db\":\"laratest\",\"table\":\"shows\"}]');
...
('root', '2020-03-15 21:19:49', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"tr\"}');
...
--
-- Tablo için tablo yapısı `business_settings`
--
...
--
-- Tablo döküm verisi `business_settings`
--
...
--
-- Tablo için tablo yapısı `coupon_usages`
--
...
--
-- Tablo için tablo yapısı `flash_deals`
--
...
--
-- Tablo için tablo yapısı `flash_deal_products`
--
...
--
-- Tablo için tablo yapısı `pickup_points`
--
...
--
-- Tablo için tablo yapısı `seller_withdraw_requests`
--
...
--
-- Tablo için tablo yapısı `sub_sub_categories`
--
...
--
-- Tablo döküm verisi `sub_sub_categories`
--
...
(3, NULL, 'seller', 'Mr. Seller', 'seller@example.com', '2018-12-11 18:00:00', '$2y$10$eUKRlkmm2TAug75cfGQ4i.WoUbcJ2uVPqUlVkox.cv4CCyGEIMQEm', 'mVlB95LnNtmjpjppqIyqxQJ8glfwBx8rZzMSIBIUMwh0Mtci7zEznmDuwLoz', 'https://lh3.googleusercontent.com/-7OnRtLyua5Q/AAAAAAAAAAI/AAAAAAAADRk/VqWKMl4f8CI/photo.jpg?sz=50', 'uploads/ucQhvfz4EQXNeTbN8Eif0Cpq5LnOwvg8t7qKNKVs.jpeg', 'Demo address', 'US', 'Demo city', '1234', NULL, 0.00, '2018-10-07 04:42:57', '2019-05-19 02:14:08'),
(8, NULL, 'customer', 'Mr. Customer', 'customer@example.com', '2018-12-11 18:00:00', '$2y$10$eUKRlkmm2TAug75cfGQ4i.WoUbcJ2uVPqUlVkox.cv4CCyGEIMQEm', 'EqAWXe1mnCiKCbthwUpBZPuyugIRTj8hrwv4SfV8kqQBAkPOMAvDpmo4Zj9L', 'https://lh3.googleusercontent.com/-7OnRtLyua5Q/AAAAAAAAAAI/AAAAAAAADRk/VqWKMl4f8CI/photo.jpg?sz=50', 'uploads/ucQhvfz4EQXNeTbN8Eif0Cpq5LnOwvg8t7qKNKVs.jpeg', 'Demo address', 'US', 'Demo city', '1234', NULL, 0.00, '2018-10-07 04:42:57', '2019-05-19 02:14:08');
...
--
-- Tablo için tablo yapısı `wishlists`
--
...
--
-- Tablo için indeksler `business_settings`
--
...
--
-- Tablo için indeksler `coupon_usages`
--
...
--
-- Tablo için indeksler `flash_deals`
--
ALTER TABLE `flash_deals`
  ADD PRIMARY KEY (`id`);

--
-- Tablo için indeksler `flash_deal_products`
--
...
--
-- Tablo için indeksler `pickup_points`
--
...
--
-- Tablo için indeksler `product_stocks`
--
...
--
-- Tablo için indeksler `seller_withdraw_requests`
--
...
--
-- Tablo için indeksler `sub_sub_categories`
--
...
--
-- Tablo için indeksler `wishlists`
--
...
--
-- Tablo için AUTO_INCREMENT değeri `business_settings`
--
ALTER TABLE `business_settings`
...
--
-- Tablo için AUTO_INCREMENT değeri `coupon_usages`
--
ALTER TABLE `coupon_usages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `flash_deals`
--
ALTER TABLE `flash_deals`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- Tablo için AUTO_INCREMENT değeri `flash_deal_products`
--
ALTER TABLE `flash_deal_products`
...
--
-- Tablo için AUTO_INCREMENT değeri `pickup_points`
--
ALTER TABLE `pickup_points`
...
--
-- Tablo için AUTO_INCREMENT değeri `product_stocks`
--
ALTER TABLE `product_stocks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Tablo için AUTO_INCREMENT değeri `seller_withdraw_requests`
--
ALTER TABLE `seller_withdraw_requests`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- Tablo için AUTO_INCREMENT değeri `sub_sub_categories`
--
ALTER TABLE `sub_sub_categories`
...
--
-- Tablo için AUTO_INCREMENT değeri `wishlists`
--
ALTER TABLE `wishlists`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
